...
if (isset($_GET['pesan'])) {
    ...
    if ($_GET['pesan'] === 'sukses_beli')   $pesan = '<div class="alert alert-success">Pembelian berhasil! Terima kasih sudah berbelanja di Digital Electronic.</div>';
}
...
<head>
    ...
    <title><?= $userRole === 'pembeli' ? 'Katalog' : 'Produk'; ?> - Digital Electronic</title>
...
<body>
    ...
    <div class="container">
        ...
        <footer class="app-footer">Digital Electronic &copy; <?= date('Y'); ?></footer>
    </div>
