...
echo "<h2>Seed 150 Produk Digital Electronic</h2>";
...
foreach ($produk as $p) {
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        $fail++;
        echo "Gagal: " . htmlspecialchars($nama) . " — " . mysqli_error($conn) . "<br>";
    }
}
mysqli_stmt_close($stmt);

echo "Total disiapkan: " . count($produk) . "<br>";
echo "Berhasil insert: <b>$ok</b><br>";
if ($fail) echo "Gagal: $fail<br>";
echo "<p><b>Selesai.</b> Hapus file seed_150.php, lalu buka Produk / Dashboard.</p>";
