...
**Digital Electronic** adalah aplikasi web toko elektronik yang mendukung multi-role (Admin, Kasir, Staff, Pembeli). Fitur utama meliputi:
...
2. **Copy** folder `DigitalElectronic` ke:
...
6. Buka browser:
   ```
   http://localhost/DigitalElectronic/
   ```
